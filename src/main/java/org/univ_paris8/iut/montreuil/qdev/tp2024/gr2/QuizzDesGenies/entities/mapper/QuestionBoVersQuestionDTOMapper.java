...
public class QuestionBoVersQuestionDTOMapper {
    ...
    public QuestionDTO convetir(QuestionBO questionBO) {
        int num_question = Integer.parseInt(questionBO.getNum_question().replaceAll("[^\\x00-\\x7F]", ""));
        int id_question = Integer.parseInt(questionBO.getId_question().replaceAll("[^\\x00-\\x7F]", ""));
        ...
        int difficulte = Integer.parseInt(questionBO.getDifficulte().replaceAll("[^\\x00-\\x7F]", ""));
